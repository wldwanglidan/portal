...
import com.tempus.portal.view.adapter.GuideAdapter;
...
public class WelcomeGuideActivity extends BaseActivity
    ...
    @BindView(R.id.btnGo) Button mBtnGo;// 进入与游
    ...
    @OnClick({ R.id.btnGo, R.id.btnJumpOver }) public void onClick(View view) {
        switch (view.getId()) {
            case R.id.btnGo:
